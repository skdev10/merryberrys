...
const navLinks = [
  ...
  { 
    ...
    href: '/shop',
    megaMenu: [
      { title: 'Men', items: ['T-Shirts', 'Shirts', 'Pants', 'Jackets', 'Accessories'] },
      { title: 'Women', items: ['Dresses', 'Tops', 'Pants', 'Outerwear', 'Accessories'] },
      { title: 'Collections', items: ['Summer 2026', 'Winter Edit', 'Essentials', 'Limited Edition'] },
    ]
  },
        ...
        <nav className="container-luxury">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-5">
              <button className="hidden lg:block p-2 text-luxury-black hover:text-luxury-gold transition-colors">
                <User size={20} strokeWidth={1.5} />
              </button>
              <button className="hidden lg:block p-2 text-luxury-black hover:text-luxury-gold transition-colors">
                <Heart size={20} strokeWidth={1.5} />
              </button>
              <Link href="/cart" className="relative p-2 text-luxury-black hover:text-luxury-gold transition-colors">
                <ShoppingBag size={20} strokeWidth={1.5} />
                {cartCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-luxury-gold text-luxury-white text-[10px] flex items-center justify-center rounded-full">
                    {cartCount}
                  </span>
                )}
              </Link>
      ...
      <div className={`fixed inset-0 bg-luxury-white z-50 transform transition-transform duration-500 ${
        ...
        <div className="container-luxury py-6">
          ...
          <div className="absolute bottom-8 left-6 right-6">
            <div className="flex items-center gap-6 pt-6 border-t border-luxury-light-gray/20">
              <button className="flex items-center gap-2 text-sm uppercase tracking-[0.1em]">
