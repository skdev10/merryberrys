...
Welcome to the Merry Berry E-Commerce project. This is a fully functional web application built with Next.js (App Router), React, Tailwind CSS, Prisma, and PostgreSQL (Vercel-friendly).
